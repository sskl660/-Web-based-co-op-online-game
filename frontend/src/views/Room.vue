<template>
  <div class="waiting-room">
    <!-- 게임 선택 모달창 -->
    <SelectGameModal v-if="openmodal == true" @getOpenModal="getOpenModal" @infoSsafyMind="infoSsafyMind" @infoSpeakGame="infoSpeakGame" @infoJumpGame="infoJumpGame"/>

    <div class="room-title">
      <span id="game-title">서울 3반 모여라!</span>
      <span id="game-code">입장코드 : A302</span>
    </div>
