<template>
    <div>
        <SSazipjumpGuideModal v-if="guideModalOpen == true" :userId="userId" :hostId="hostId" @guideModal="guideModal" />
        <SSazipjumpStartModal v-if="startModalOpen == true" :userId="userId" :hostId="hostId" @getCloseModal="closeStartModal" />
        <SSazipjumpRoundModal v-if="roundModalOpen == true" :battleTeam1="battleTeam1" :battleTeam2="battleTeam2" :userId="userId" :hostId="hostId" @getCloseModal="closeRoundModal" />
        <SSazipjumpRankModal v-if="rankModalOpen == true" :userId="userId" :hostId="hostId" @getCloseModal="closeStartModal" />
                    ...
                    <div class="ssazip-round-inner-container">
                        <div class="ssazip-round-item" style="background-color:#9EACDD; margin-top:1.2vh;">
                            <div class="ssazip-round-item-inner">
                                ...
                                <div class="ssazip-rounds-container">
                                    <img class="current-round-team-individual" style="margin-right: 30px;" :src="require(`@/assets/team${battleTeam1}.png`)" alt="" />
                                    <div class="ssazip-vs">vs</div>
                                    <img class="current-round-team-individual" style="margin-left: 30px;" :src="require(`@/assets/team${battleTeam2}.png`)" alt="" />
                                    <div class="ssazip-league">8강</div>
                                </div>
                            </div>
                        </div>
                        <div class="ssazip-round-item" style="background-color:#EAC16F; margin-top:2.5vh;">
                            <div class="ssazip-round-item-inner">
                                ...
                                <div class="ssazip-rounds-container">
                                    <img class="current-round-team-individual" style="margin-right: 30px;" :src="require(`@/assets/team${nextBattleTeam1}.png`)" alt="" />
                                    <div class="ssazip-vs">vs</div>
                                    <img class="current-round-team-individual" style="margin-left: 30px;" :src="require(`@/assets/team${nextBattleTeam2}.png`)" alt="" />
                                    <div class="ssazip-league">8강</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ssazip-round-item" style="background-color:#B9D272;margin-top:2.5vh;">
                            <div class="ssazip-round-item-inner">
                                ...
                                <div class="ssazip-score-container">
                                    <div class="team-round-score" >{{gameScore1}} : {{gameScore1}}</div>
                                    <div class="ssazip-round-score-teams">
                                        <span style="margin-right:25px;">{{battleTeam1}}팀</span>
                                        <span style="margin-left:50px">{{battleTeam1}}팀</span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    data: function() {
        return {
            ...
            hostId: '박용미', //호스트 유저의 이름이 었을껄?
            battleTeam1: 1, // 진행 될 경기 팀
            battleTeam2: 2,
            nextBattleTeam1: 3, //다음 진행 될 경기 팀
            nextBattleTeam2: 4,
            nowRoundNum: 3, // 현재 라운드 회차
            gameScore1: 1, // 현 라운드에서 1팀이 이긴 값
            gameScore2: 1, // ''
            loser:'이장섭',//걸린이 이름 : 희은이가 지음

            guideModalOpen: false, //게임시작시 첫시작 소개모달
